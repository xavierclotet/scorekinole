...
> For full details on the registration flow, concurrency model, doubles modes, admin tooling, and known issues see **[TOURNAMENT_REGISTRATION.md](./TOURNAMENT_REGISTRATION.md)**.
